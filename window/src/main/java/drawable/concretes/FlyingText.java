...
import drawable.abstracts.DrawableCreatureMoving;
...
public class FlyingText extends DrawableCreatureMoving {
    ...
    public FlyingText(String text, Vector2D position, Trajectory trajecotry, int colorSize, Color color) { // uups :)
        super(new MovingObject(position, new Vector2D(100, colorSize), trajecotry), new Text(text, color), null);
    }
